...
<xsl:template match="/">
    ...
    <html>
            ...
            <link href="morfologiaStyle.css" rel="stylesheet" type="text/css"/>
                ...
                <div id="pagina18">
                   <h1 id="pag18">PAGINA 18</h1> 
                        <div class="boxTrascrizione"> 
							...
							<div class="box-trascrizione1">
								<div class="trascrizione">
									 <xsl:apply-templates select="//tei:text//tei:pb[@n = '18']/following-sibling::*[count(preceding-sibling::tei:pb) = 1]"/> 
								</div>  
							</div> 
                                ...
                                <h2 id="legenda">LEGENDA</h2>
                                   ...
                                   <p id="fucsia">Correzioni<br></br>Normalizzazioni </p>
                                   <p id="blue">Parole straniere </p>
								</div>	
								<div class="box-btn">
								<h2 class="bntTitoloLeg">VISUALIZZA</h2>
						...
						<div class="box-traduzione">
							<p class='text-traduzione'>
							 <xsl:apply-templates select="//tei:text//tei:pb[@n = '18']/following-sibling::*[count(preceding-sibling::tei:pb) = 3]"/> 
							</p>
                        </div>
				 ...
				 <div id="pagina19" class="box-pag19">
                   <h1 id="pag19">PAGINA 19</h1> 
                        <div class="boxTrascrizione"> 
							<div class="img-wrapper">
								<xsl:element name="img">
									...
									<xsl:attribute name="id">frontepag19</xsl:attribute>
								</xsl:element>
							</div>
							
							<div class="box-trascrizione2">
								<div class="trascrizione">
									 <xsl:apply-templates select="//tei:text//tei:pb[@n = '18']/following-sibling::*[count(preceding-sibling::tei:pb) = 2]"/> 
								</div>  
							</div>  
							<div class='box-legenda'>
                                <h2 id="legenda">LEGENDA</h2>
						...
						<div class="box-traduzione">
							<p class='text-traduzione'>
							 <xsl:apply-templates select="//tei:text//tei:pb[@n = '18']/following-sibling::*[count(preceding-sibling::tei:pb) = 4]"/> 
							</p>
                        </div>
                </div>
	...
	<!-- Formattazione lb (lascia due spazi tra gli lb)-->
	...
	<xsl:template match="tei:add">
		...
		<span class="hidden"><xsl:value-of select="$addContent"/></span>
	</xsl:template>
	...
	<xsl:element name="span"> 
		...
		<xsl:element name="span">
				 <xsl:attribute name="class">espansioni</xsl:attribute> 
